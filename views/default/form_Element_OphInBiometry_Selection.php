...
<section class="element <?php echo $element->elementType->class_name?>"
	...
	data-element-display-order="<?php echo $element->elementType->display_order?>">	<div class="element-fields element-eyes row">
		...
		<div id="right-eye-selection" class="element-eye right-eye left side column  <?php if (!$element->hasRight()) {
    ?> inactive<?php 
} ?>"
		...
		<div id="left-eye-selection" class="element-eye left-eye right side column <?php if (!$element->hasLeft()) {
    ?> inactive<?php 
} ?>"
