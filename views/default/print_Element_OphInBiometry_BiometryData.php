...
<table class="subtleWhite normalText">
	<tbody>
		<tr>
			...
			<td><span class="big"><?php echo CHtml::encode($element->axial_length)?></span></td>
		</tr>
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('r1'))?></td>
			<td><span class="big"><?php echo CHtml::encode($element->r1)?></span></td>
		</tr>
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('r2'))?></td>
			<td><span class="big"><?php echo CHtml::encode($element->r2)?></span></td>
		</tr>
	</tbody>
</table>
