...
class Element_OphInBiometry_Measurement extends SplitEventTypeElement
{
	...
	public function rules()
	{
		...
		return array(
			...
			//snr_left & snr_right value need to updated by after confimation from JM & Natasha
			array('snr_left', 'checkNumericRangeIfSide', 'side'=>'left','integerOnly' => true, 'max' => 400, 'min' => 0),
			array('snr_right', 'checkNumericRangeIfSide', 'side'=>'right','integerOnly' => true, 'max' => 400, 'min' => 0),
