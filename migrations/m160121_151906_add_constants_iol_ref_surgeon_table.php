...
class m160121_151906_add_constants_iol_ref_surgeon_table extends CDbMigration
{
	public function up()
	{
		...
		$this->addColumn('et_ophinbiometry_iol_ref_values_version', 'constant', 'decimal(6,2)');
		$this->addColumn('et_ophinbiometry_iol_ref_values_version', 'constant1', 'decimal(6,2)');
		$this->addColumn('et_ophinbiometry_iol_ref_values_version', 'constant2', 'decimal(6,2)');
