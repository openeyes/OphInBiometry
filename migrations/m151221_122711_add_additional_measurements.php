...
class m151221_122711_add_additional_measurements extends CDbMigration
{
	public function up()
	{
		...
		$this->addColumn('et_ophinbiometry_measurement_version','al_modified_left', 'boolean default false after  comments');
		$this->addColumn('et_ophinbiometry_measurement_version','al_modified_right', 'boolean default false after comments');
		$this->addColumn('et_ophinbiometry_measurement_version','k_modified_left', 'boolean default false after comments');
		$this->addColumn('et_ophinbiometry_measurement_version','k_modified_right', 'boolean default false after comments');
	}
